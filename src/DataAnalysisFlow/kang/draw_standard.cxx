...
void plot(const char* file1, const char* file2, const char* tree, const char* branch, int nbin, double min, double max) {
    ...
    hist1->Scale(24*60/scale1);    // 缩放因子 = 1 / 积分
...
void draw_standard(){
	...
	//plot("test/LD.root", "test/LD_BKG.root", "tree1", "filamp",1000,1E4,.8E6);   
	//plot("test/LMO.root", "test/LMO_BKG.root", "tree1", "rawamp",1000,2E4,.8E6);   
	plot("test/LMO.root", "test/LMO_BKG.root", "tree1", "filamp",1000,1E4,.8E6);   
