...
void plot(const char* file1, const char* file2, const char* tree, const char* branch, int nbin, double min, double max) {
    ...
    //double integral1 = hist1->Integral(); // 获取总积分
    //double integral2 = hist2->Integral(); // 获取总积分
...
void draw_nolog(){
	...
	//plot("test/LD.root", "test/LD_BKG.root", "tree1", "rawamp",1000,1E4,.8E6);   
	//plot("test/LD.root", "test/LD_BKG.root", "tree1", "filamp",200,0,.2E6);   
	plot("/mnt/e/RUNs_data_analysis/RUN2408/Converted_Data/root/1cmLMO_SB12_T6at9p46mK_bkg_4h40min_5kHz_2408200106/light.root", "/mnt/e/RUNs_data_analysis/RUN2408/Converted_Data/root/1cmLMO_SB12_T6at9p46mK_bkg_4h40min_5kHz_2408200106/TriggerEvent.root", "tree1", "filamp",200,3000,1.5E4);   
	//plot("test/LD.root", "test/LD_BKG.root", "tree1", "rawamp",800,-2E3,.8E6);   
	//plot("test/LMO.root", "test/LMO_BKG.root", "tree1", "rawamp",1000,2E4,.8E6);   
	//plot("test/LMO.root", "test/LMO_BKG.root", "tree1", "filamp",400,3E3,1.2E4);   
	//plot("test/LMO.root", "test/LMO_BKG.root", "tree1", "rawamp",400,-.3E5,1.2E5);   
